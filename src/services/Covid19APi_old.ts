...
import { Summary, CountrySummary, Country, DailyReportItem } from '../types';
...
class Covid19Api {
    ...
    private formatReportData(response: AxiosResponse): Summary {
        ...
        return{
            ...
            deaths: deaths.value,
            lastUpdate: moment(lastUpdate).format('MM-DD-YYYY HH:mm')
        }
    }

    private formatCountriesSummaryData(data: Array<CountrySummary>): Map<string,Summary> {
